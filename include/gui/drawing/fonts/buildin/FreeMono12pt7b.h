...
const DrawFont::Glyph FreeMono12pt7bGlyphs[] PROGMEM = {
    {0, 0, 0, 14, 0, 1},        // 0x20 ' '
    {0, 3, 15, 14, 6, -14},     // 0x21 '!'
    {6, 8, 7, 14, 3, -14},      // 0x22 '"'
...
const DrawFont FreeMono12pt7b PROGMEM = {
    (uint8_t*)FreeMono12pt7bBitmaps,
    (DrawFont::Glyph *)FreeMono12pt7bGlyphs,
    ' ', '~', 24,
    Bitmap::Flags(Bitmap::BigEndian | Bitmap::XPrimary), "FreeMono 12pt7b"};
